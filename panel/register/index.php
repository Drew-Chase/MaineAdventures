...
<body>
    ...
    ?>
    <div id="register-form" class="col form">
        <header class="col">
        ...
        <input type="password" name="password" id="confirm-password" placeholder="Confirm Password" autocomplete="new-password" required>
        ...
        <div id="button-panel" class="row center">
            ...
            <a href="/panel/login" class="btn secondary dark">Login</a>
